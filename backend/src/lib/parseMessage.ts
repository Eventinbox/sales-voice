...
import { callGemma, isGemmaConfigured } from "./gemma";

export type ParsedIntent =
  | { kind: "sale"; item: string; amount: number; buyerName?: string }
  | {
      kind: "debt";
      personName: string;
      item: string;
...
function parseMessageHeuristic(text: string): ParsedIntent {
